...
import { useGetAllHolidays, useAddHoliday, useEditHoliday, useDeleteHoliday } from '../../hooks/useQueries';
import { Holiday } from '../../backend';
      ...
      {isOwner && showAddForm && (
        ...
        >
          ...
          <form onSubmit={handleSubmitAdd}>
            ...
            <div style={{ marginBottom: '14px' }}>
              <label style={labelStyle}>Holiday Description (optional)</label>
              <textarea
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  fontWeight: 600,
                  cursor: addHolidayMutation.isPending ? 'not-allowed' : 'pointer',
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  fontWeight: 600,
                  cursor: editHolidayMutation.isPending ? 'not-allowed' : 'pointer',
              ...
              <button
                type="button"
                onClick={() => { setEditingHoliday(null); resetForm(); }}
                style={{
                  backgroundColor: '#fff',
                  color: '#444',
                  border: '1px solid #CFCFCF',
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: '15px', fontWeight: 700, color: '#1a1a1a', margin: '4px 0 0 0' }}>
                    {holiday.name}
                  </p>
                  {holiday.description && (
                    <p style={{ fontSize: '13px', color: '#555', margin: '6px 0 0 0', lineHeight: '1.5' }}>
                      {holiday.description}
                    </p>
                  )}
                </div>
